...
@st.cache_resource #It run only once
...
def get_trained_model():
    ...
    for student in student_db:
        embedding=student.get('face_embbedding')
        if embedding:
...
def train_classifier():
    st.cache_resource.clear() # Clear the cache of old student
...
def predict_attendence(class_image_np):
    ...
    if not model_data:
        return detected_student, [], len(encodings) # list of student , embeddings, no. of students
